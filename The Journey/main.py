...
def begin_game():
    ...
    #importer et charger le bouton restart
    rest_button = pygame.image.load('im/arrows.png')
    rest_button = pygame.transform.scale(play_button, (600, 150))
    rest_button_rect = play_button.get_rect()
    rest_button_rect.x = screen.get_width() / 3.33
    rest_button_rect.y = screen.get_height() / 2
